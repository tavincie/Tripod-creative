...
export function ContactBookingExperience({
  ...
  const contactItems = [
    ...
    },
    {
      ...
      value: siteConfig.phone || tContact('contacts.items.phone.fallback'),
      href: siteConfig.phone ? `tel:${siteConfig.phone}` : undefined,
      external: Boolean(siteConfig.phone),
    },
    {
      icon: Mail,
      title: tContact('contacts.items.email.title'),
      value: siteConfig.email || tContact('contacts.items.email.fallback'),
      href: siteConfig.email ? `mailto:${siteConfig.email}` : undefined,
      external: Boolean(siteConfig.email),
    },
    {
      icon: Globe,
    ...
    },
    {
      ...
      value: tContact('contacts.items.location.fallback'),
    },
  ];
  ...
  return (
    <main className="relative flex-grow overflow-hidden">
      <section className="relative overflow-hidden border-b border-white/6 bg-[linear-gradient(180deg,#050505_0%,#050505_72%,#090909_100%)] pb-16 pt-28 sm:pt-32 lg:pb-24 lg:pt-36">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_14%_20%,rgba(255,124,72,0.24),transparent_24%),radial-gradient(circle_at_84%_24%,rgba(245,241,233,0.08),transparent_20%),repeating-linear-gradient(90deg,rgba(245,241,233,0.04)_0_1px,transparent_1px_9rem)] opacity-90" />
