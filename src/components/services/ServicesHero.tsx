  ...
  return (
    ...
    >
      <div className="relative">
        <div className="absolute inset-[8%_14%_14%_18%] rounded-full bg-[radial-gradient(circle,rgba(255,61,0,0.24),rgba(255,61,0,0)_72%)] blur-3xl" />
        <div className="relative overflow-hidden rounded-[1.5rem] border border-white/10 bg-black p-4 sm:p-5">
          ...
          <div className="relative min-h-[15rem] overflow-hidden rounded-[1.1rem] border border-white/12 bg-black sm:min-h-[18rem] lg:min-h-[22rem]">
            <Image
              src={media.src}
